...
**• DEMANOU FOUDJI Karl Albert Kuete 24F2995**:Développement de la librairie operation.h pour les  operations sur les photos PPM et adaption des fonctions utiliataires de la librairie PPM_io.h pour l'implémentation du fichier operation.c
